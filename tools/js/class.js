...
function make_dens_table(c_clip) {
    ...
    for (var i = 0; i < ary.length; i++) {
        ...
        $div.append(
            $('<div>').text("#" + ("000" + mes).slice(-3))
        );

        $div.append(
            $('<div>').text(
                String(ary[i][0])+String(ary[i][1])+String(ary[i][2])+String(ary[i][3])+" "+
                String(ary[i][4])+String(ary[i][5])+String(ary[i][6])+String(ary[i][7])+" "+
                String(ary[i][8])+String(ary[i][9])+String(ary[i][10])+String(ary[i][11])+" "+
                String(ary[i][12])+String(ary[i][13])+String(ary[i][14])+String(ary[i][15])
            )
        );

        $div.append(
            $('<div>').text(
                String(ary[i][0] + ary[i][1]) + String(ary[i][2] + ary[i][3]) + " " +
                String(ary[i][4] + ary[i][5]) + String(ary[i][6] + ary[i][7]) + " " +
                String(ary[i][8] + ary[i][9]) + String(ary[i][10] + ary[i][11]) + " " +
                String(ary[i][12] + ary[i][13]) + String(ary[i][14] + ary[i][15])
            )
        );
        ...
        $div.append(
            $('<div>').text(
                String(ary[i][0] + ary[i][1] + ary[i][2] + ary[i][3] + ary[i][4] + ary[i][5] + ary[i][6] + ary[i][7]) + " " +
                String(ary[i][8] + ary[i][9] + ary[i][10] + ary[i][11] + ary[i][12] + ary[i][13] + ary[i][14] + ary[i][15])
            )
        );

        var all = ary[i][0] + ary[i][1] + ary[i][2] + ary[i][3] + ary[i][4] + ary[i][5] + ary[i][6] + ary[i][7] +
                ary[i][8] + ary[i][9] + ary[i][10] + ary[i][11] + ary[i][12] + ary[i][13] + ary[i][14] + ary[i][15];
    ...
    $div_base.prepend($('<div style="margin-top: 10px;">').text((ave_sigma / ave_n) + " n/mes"));
    $("#mitudo_result").text("");
